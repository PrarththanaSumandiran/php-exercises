...
<div class="form-group" style="margin-bottom:20px;">
  ...
  <div class="form-group"  style="margin-bottom:20px;">
    ...
    <input type="text" class="form-control" name="first name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter first name">
  </div>
  <div class="form-group"  style="margin-bottom:20px;">
    <label for="exampleInputEmail1">last name</label>

    <input type="text" class="form-control" name="last name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter last name">
  </div>
  <div class="form-group"  style="margin-bottom:20px;">
    <label for="exampleInputEmail1">date of birth</label>

    <input type="text" class="form-control" name="date of birth" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter date of birth ">
  </div>
  <div class="form-group"  style="margin-bottom:20px;">
